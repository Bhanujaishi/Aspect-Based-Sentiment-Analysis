...
def input(request):
    if request.method=='POST':
        ...
        pathname = "C:/Users/HP/SE_Project1/sentimental_analysis/media/"
        ...
        if extension_name == 'pdf':
            ...
            with sr.AudioFile(path) as source:
                ...
                result = detailed_analysis(value)
        # Sentiment Analysis
        os.system('cd C:/Users/HP/SE_Project1/sentimental_analysis/media&& rm -rf *')
...
def productanalysis(request):
    if request.method=='POST':
        ...
        text_file = open("C:/Users/HP/SE_Project1/Amazon_Comments_Scrapper/amazon_reviews_scraping/amazon_reviews_scraping/spiders/ProductAnalysis.txt", "w")
        text_file.write(blogname)
        text_file.close()
        os.remove('reviews.json')
        os.system('scrapy runspider C:/Users/HP/SE_Project1/Amazon_Comments_Scrapper/amazon_reviews_scraping/amazon_reviews_scraping/spiders/amazon_review.py -o reviews.json')
        final_comment = []
        with open('C:/Users/HP/SE_Project1/sentimental_analysis/reviews.json') as json_file:
